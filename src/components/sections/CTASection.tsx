  ...
  return (
    <section className="relative py-12 md:py-24 lg:py-32 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(197,83%,18%) 0%, hsl(188,90%,28%) 55%, hsl(188,96%,36%) 100%)",
        }}
        aria-hidden="true"
      />
      {/* Décoration */}
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <FadeIn direction="up">
          ...
          <p className="text-white/70 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Notre équipe est joignable 7 jours sur 7, de 7h à 20h en semaine
            et de 8h à 18h le weekend. Une réponse en moins de 2h garantie.
          </p>
